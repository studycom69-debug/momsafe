...
function VitalCard({
  ...
  const defaultNumericValue =
    typeof vital.value === "number"
      ? vital.value
      : parseFloat(String(vital.value).split("/")[0]) || 0;
  ...
  const activeNumericValue =
    selectedHistoryIndex !== null
      ? recentHistory[selectedHistoryIndex]
      : defaultNumericValue;
  ...
  const activeStatus =
    selectedHistoryIndex !== null
      ? getStatusForValue(activeNumericValue, vital.label)
      : vital.status;
  ...
  const formattedDisplayValue =
    typeof vital.value === "string" && vital.value.includes("/")
      ...
      className={`card p-5 transition-all duration-300 relative overflow-visible group border-2
        ${
          activeStatus === "critical"
            ? "border-red-500 shadow-lg shadow-red-100 bg-red-50/30"
            : activeStatus === "warning"
              ? "border-amber-400 shadow-md shadow-amber-100 bg-amber-50/20"
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div
            className={`px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-wider border shadow-sm transition-colors duration-300
            ${
              activeStatus === "normal"
        ...
        <div className="mb-4">
          ...
          <div
            className={`flex items-center gap-1.5 mt-1 text-[10px] font-black transition-colors duration-300 ${vital.trend === "up" ? (vital.label === "Blood Pressure" || vital.label === "Heart Rate" ? "text-red-500" : "text-emerald-600") : vital.trend === "down" ? (vital.label === "SpO2" ? "text-red-500" : "text-emerald-600") : "text-gray-400"}`}
          >
            {vital.trend === "up" ? (
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-1.5">
            <div
              className={`w-1.5 h-1.5 rounded-full transition-colors duration-300 ${activeStatus === "normal" ? "bg-emerald-500" : activeStatus === "warning" ? "bg-amber-500" : "bg-red-500"}`}
            />
      ...
      <div className="space-y-4 relative z-20 pt-4 border-t border-gray-100/50 mt-3">
            ...
            <div className="h-1.5 w-full bg-gray-100 rounded-full relative cursor-help">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max px-3 py-1.5 bg-gray-900 text-white text-[10px] font-bold rounded-lg opacity-0 group-hover/bar:opacity-100 transition-opacity pointer-events-none z-30 shadow-xl flex flex-col items-center gap-0.5">
                <span className="text-gray-300">
                  Normal range: {vital.safeRange.min}-{vital.safeRange.max}{" "}
                  {vital.unit}
                </span>
                <span
                  className={
                    activeNumericValue > vital.safeRange.max
                      ? "text-amber-400"
                      : activeNumericValue < vital.safeRange.min
                        ? "text-amber-400"
                        : "text-emerald-400"
                  }
                >
        ...
        <div className="flex flex-col items-center pt-2">
          <span className="text-[8px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-2">
            Recent readings
          </span>
            ...
            {recentHistory.map((h, i) => {
              ...
              const timeAgo = ts
                ...
                : i === recentHistory.length - 1
                  ? "Just now"
                  : `${(recentHistory.length - 1 - i) * 2}h ago`;
              const isSelected =
...
function VitalFocusModal({
  ...
  const getExplanation = () => {
    if (vital.label === "Heart Rate")
      return "Your heart rate reflects how hard your body is working to support you and your baby.";
    if (vital.label === "Blood Pressure")
      return "BP monitoring is crucial to detect signs of preeclampsia early.";
    if (vital.label === "SpO2")
      return "Oxygen saturation measures how well your lungs are delivering oxygen to your bloodstream.";
    return "This reading helps monitor your overall physiological stability.";
  };

  const getAction = () => {
    if (vital.status === "critical")
      return "Contact your healthcare provider immediately or use the Emergency Help button.";
    if (vital.status === "warning")
      return "Rest, hydrate, and re-check in 30 minutes. Log any symptoms.";
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`p-8 text-white ${vital.status === "normal" ? "bg-emerald-600" : vital.status === "warning" ? "bg-amber-500" : "bg-red-600"}`}
        >
          ...
          <div className="flex items-baseline gap-3">
            ...
            <span className="text-2xl font-bold opacity-60 uppercase">
              {vital.unit}
            </span>
          </div>
        ...
        <div className="p-10 space-y-8">
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-700 font-medium leading-relaxed">
                Consistent readings in this range indicate good cardiovascular
                health and proper fetal support.
              </p>
            </div>
...
const DEFAULT_VITALS: Vital[] = [
  {
    ...
    trend: "stable",
    change: "0",
    history: [72, 75, 71, 78, 74, 76, 73],
    safeRange: { min: 60, max: 100 },
    stability: "Stable",
  },
  {
    id: 2,
    ...
    trend: "stable",
    change: "0",
    history: [118, 120, 115, 122, 119, 121, 117],
    safeRange: { min: 90, max: 140 },
    stability: "Stable",
  },
  {
    id: 3,
    ...
    trend: "stable",
    change: "0",
    history: [98, 99, 98, 97, 98, 99, 98],
    safeRange: { min: 95, max: 100 },
    stability: "Stable",
  },
  {
    id: 4,
    ...
    trend: "stable",
    change: "0",
    history: [36.5, 36.6, 36.4, 36.7, 36.5, 36.6, 36.5],
    safeRange: { min: 36.1, max: 37.2 },
    stability: "Stable",
  },
  {
    id: 5,
    ...
    trend: "stable",
    change: "0",
    history: [68.2, 68.4, 68.3, 68.5, 68.4, 68.6, 68.5],
    safeRange: { min: 45, max: 120 },
    stability: "Stable",
  },
];
...
export default function Dashboard() {
  ...
  const [dashboardData, setDashboardData] = useState({
    risk: {
      ...
      level: "Low",
      change: 0,
      explanation: "Evaluating your health data...",
      lastUpdated: "Just now",
      breakdown: { vitals: 0, sleep: 0, hydration: 0, symptoms: 0 },
    },
    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-gray-900/95 backdrop-blur-md border border-gray-700/50 p-4 rounded-2xl shadow-2xl z-50 min-w-[160px]">
          <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-3 border-b border-gray-700/50 pb-2">
            {label}
          </p>
          <div className="space-y-2.5">
            {payload.map((entry: any, index: number) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-black tabular-nums ${entry.name.includes("(Prev)") ? "text-gray-400" : "text-white"}`}
                >
                  {entry.value}
                </span>
              </div>
  ...
  const generateOverallInsight = (
    ...
    if (!vitals && !sleep && water === 0)
      return "No data yet. Start logging your vitals and daily habits to see your health summary.";

    const reasons: string[] = [];

    if (vitals) {
      if (Number(vitals.systolic_bp) >= 140)
        reasons.push("your blood pressure is higher than normal");
      if (Number(vitals.heart_rate) >= 100)
        reasons.push("your heart rate is elevated");
      if (Number(vitals.temperature) >= 38) reasons.push("you have a fever");
      if (Number(vitals.spo2) < 94)
        reasons.push("your oxygen levels are slightly low");
    }

    if (sleep && Number(sleep.sleep_hours) < 6)
      reasons.push("you are getting less sleep than recommended");
    if (water < 1.5) reasons.push("your hydration is lower than ideal");
    if (gestationalWeek >= 28)
      reasons.push(
        "you are in a later stage of pregnancy which needs extra care",
      );
  ...
  const chartData = useMemo(() => {
    ...
    console.log(
      `[Trends] period=${period} | rawVitals=${rawVitals.length} | filtered=${filtered.length}`,
      filtered[0]?.recorded_at,
    );
  ...
  const trendSummary = useMemo(() => {
    if (chartData.length < 2)
      return { text: "Vitals are stable", tag: "Stable", color: "emerald" };
    ...
    if (Math.abs(hrDiff) > 10)
      return {
        text: "There is some fluctuation in your vitals",
        tag: "Fluctuating",
        color: "amber",
      };
    if (hrDiff < -2)
      return {
        text: "Your vitals are improving this week",
        tag: "Improving",
        color: "emerald",
      };
    if (hrDiff > 2)
      return {
        text: "Watching slight upward trends",
        tag: "Monitor",
        color: "blue",
      };
    return {
      text: "Vitals are perfectly stable",
      tag: "Stable",
      color: "emerald",
    };
  }, [chartData]);
  ...
  const pushSafeVitalsReading = useCallback(async () => {
    ...
    if (
      error &&
      (isMissingVitalsColumn(error, "source") ||
        isMissingVitalsColumn(error, "steps"))
    ) {
      const fallbackPayload: any = { ...payload };
      delete fallbackPayload.source;
      delete fallbackPayload.steps;
    ...
    try {
      ...
      const [
        ...
        supabase
          .from("users")
          .select(
            "full_name, age, gestational_week, due_date, medical_history, doctor_name, conditions",
          )
          .eq("id", userId)
          .maybeSingle(),
      ...
      const latestBpRow =
        vitalsRows.find(
          (r) => r?.systolic_bp != null && r?.diastolic_bp != null,
        ) || null;
      const latestSystolicBp = latestBpRow
        ? Number(latestBpRow.systolic_bp)
        : null;
      const latestDiastolicBp = latestBpRow
        ? Number(latestBpRow.diastolic_bp)
        : null;

      // 1. Process Risk Score (Frontend Weighted Calculation)
      const totalAmount = Number(
        (waterDataToday || [])
          .reduce((sum, row) => sum + Number(row.amount_liters || 0), 0)
          .toFixed(1),
      );
      ...
      const risk = {
        ...
        lastUpdated: latestVitals?.recorded_at
          ? formatDistanceToNow(new Date(latestVitals.recorded_at)) + " ago"
          : "Just now",
        breakdown: {
      ...
      const vitalsList = DEFAULT_VITALS.map((v) => {
        ...
        if (v.label === "Blood Pressure") {
          const sys =
            latestSystolicBp ?? toFiniteOrNull(latestVitals.systolic_bp);
          const dia =
            latestDiastolicBp ?? toFiniteOrNull(latestVitals.diastolic_bp);
        ...
        if (v.label === "Temperature") {
          const t =
            latestTemperature ?? toFiniteOrNull(latestVitals.temperature);
          val = t ?? "--";
      ...
      const severityMapDash: Record<string, number> = {
        immediate: 0,
        high: 1,
        monitor: 2,
      };
      ...
      if (moodValue) {
        if (
          ["happy", "good", "great", "excellent", "calm"].includes(moodValue)
        ) {
      ...
      const performanceScore = Math.round(
        (hydration.pct + sleep.pct + moodScore) / 3,
      );

      const latestStepsRow = (allVitalsForTrends || []).find(
        (r: any) => r?.steps != null,
      );
      ...
      if (activityWater) {
        activityWater.forEach((w) => {
          ...
          if (dailyLogsByDate[dateStr].water === "--")
            dailyLogsByDate[dateStr].water = 0;
      ...
      Object.keys(dailyLogsByDate).forEach((dateStr) => {
        ...
        const waterStr =
          typeof log.water === "number" ? log.water.toFixed(1) : log.water;
        newFeed.push({
          id: `d-${dateStr}`,
          type: "log",
      ...
      const summarizedFeed = Object.values(groupedActivities).map(
        (group: any) => {
          if (group.count > 1) {
            let title = "";
            ...
            return {
              ...
              type: group.type,
              title: title,
              description: `${title} ${group.count} times today`,
      ...
      const finalSortedFeed = summarizedFeed.sort(
      ...
      finalSortedFeed.forEach((item) => {
        ...
        else if (diffHours < 24 && isToday(item.rawDate))
          timeStr = `${diffHours} hours ago`;
        else if (isYesterday(item.rawDate))
          timeStr = `Yesterday ${format(item.rawDate, "h:mm a")}`;
      ...
      if (todayArr.length > 0)
        groupedFeed.push({ header: "Today", items: todayArr });
      if (yesterdayArr.length > 0)
        groupedFeed.push({ header: "Yesterday", items: yesterdayArr });
      if (earlierArr.length > 0)
        groupedFeed.push({ header: "Earlier", items: earlierArr });

      // 6. Trends & Profile
      const trends = allVitalsForTrends
        ? allVitalsForTrends.map((r: any) => ({
            time:
              period === "24h"
                ? formatDistanceToNow(new Date(r.recorded_at), {
                    addSuffix: true,
      ...
      const guidanceInput: UserHealthData = {
        ...
        pregnancy: {
          ...
          age: userProfile?.age,
          medical_conditions: userProfile?.conditions
      ...
      const aiGuidance = [
        guidanceResult.topPriority,
        guidanceResult.secondary,
      ].filter((i): i is GuidanceItem => i !== null);
      const overallInsight = generateOverallInsight(
        latestVitals,
        sleepDataToday,
        totalAmount,
        userProfile?.gestational_week || 32,
      );
  ...
  return (
    <div className="space-y-6">
                ...
                <div className="relative z-10 flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-black leading-tight">
                      {dashboardData.risk.level} Risk Level
                    </h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {[
                      {
                        label: "Vitals",
                        value: dashboardData.risk.breakdown.vitals,
                        icon: Activity,
                        color: "blue",
                        max: 40,
                      },
                      {
                        label: "Sleep",
                        value: dashboardData.risk.breakdown.sleep,
                        icon: Moon,
                        color: "purple",
                        max: 20,
                      },
                      {
                        label: "Hydration",
                        value: dashboardData.risk.breakdown.hydration,
                        icon: Droplets,
                        color: "cyan",
                        max: 20,
                      },
                      {
                        label: "Symptoms",
                        value: dashboardData.risk.breakdown.symptoms,
                        icon: Zap,
                        color: "amber",
                        max: 20,
                      },
                      ...
                      <div key={factor.label} className="space-y-2">
                        <div className="flex justify-between items-end">
                          <div className="flex items-center gap-2">
                            <factor.icon
                              className={`w-3.5 h-3.5 text-${factor.color}-500`}
                            />
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="page-subtitle">
            Actively monitoring your vitals and health status.
          </p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <span className="flex items-center gap-1">
              <span
                className={`w-2 h-2 rounded-full ${isHardwareStreaming ? "bg-emerald-400 animate-pulse" : "bg-gray-300"}`}
              />
        ...
        >
          <div className="flex items-start justify-between mb-6 relative z-10">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="group/tip relative">
                    ...
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-[10px] font-bold rounded-lg opacity-0 group-hover/tip:opacity-100 pointer-events-none transition-all w-48 text-center shadow-xl z-20 leading-relaxed">
                      This score is calculated using vitals, sleep, hydration,
                      and symptoms.
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              {dashboardData.risk.change !== 0 && (
                <div
                  className={`flex items-center gap-1 text-[10px] font-black ${dashboardData.risk.change < 0 ? "text-emerald-600" : "text-red-600"}`}
                >
                  {dashboardData.risk.change < 0 ? (
                    <TrendingDown className="w-3 h-3" />
                  ) : (
                  ...
                  {Math.abs(dashboardData.risk.change)}%{" "}
                  {dashboardData.risk.change < 0
                    ? "Improved"
                    : "Increased risk"}
                </div>
          ...
          <div className="flex items-end gap-6 mb-8 relative z-10">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-2xl text-gray-300 font-black tracking-tight">
                / 100
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2">
                {[Heart, Wind, Droplets, Moon].map((Icon, i) => (
                  <div
                    key={i}
                    className="w-7 h-7 rounded-full bg-white border-2 border-gray-50 flex items-center justify-center text-gray-400 shadow-sm"
                  >
              ...
              <p className="text-xs text-gray-500 font-medium">
                Multidimensional data sync active
              </p>
            </div>
          ...
          <div
            className={`absolute top-0 right-0 w-64 h-64 opacity-[0.03] -translate-y-1/2 translate-x-1/4 rounded-full blur-3xl pointer-events-none ${
              dashboardData.risk.level === "Low"
                ? "bg-emerald-600"
                : dashboardData.risk.level === "Moderate"
                  ? "bg-amber-600"
        ...
        <Link href="/analytics" className="block no-underline h-full">
          <motion.div
            ...
            className={`h-full card p-6 cursor-pointer transition-all duration-300 relative overflow-hidden flex flex-col justify-between
              ${
                !dashboardData.aiGuidance[0] ||
                dashboardData.aiGuidance[0].severity === "low"
                  ? "bg-gradient-to-br from-white to-emerald-50/10 border-emerald-100 hover:shadow-emerald-100/20"
                  : dashboardData.aiGuidance[0].severity === "high"
                    ? "bg-gradient-to-br from-white to-red-50/10 border-red-100 hover:shadow-red-100/20"
          ...
          >
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                >
                  {!dashboardData.aiGuidance[0]
                    ...
                    : dashboardData.aiGuidance[0].severity === "high"
                      ? "Urgent"
                      : dashboardData.aiGuidance[0].severity === "medium"
                        ? "Attention"
                        : "Stable"}
                </div>
              </div>
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-black text-gray-900 tracking-tight leading-tight">
                  {dashboardData.aiGuidance[0]?.title ||
                    "Everything looks stable"}
                </h3>
                <p className="text-sm text-gray-500 font-medium leading-relaxed line-clamp-2">
                  {dashboardData.aiGuidance[0]?.description ||
            ...
            <div className="relative z-10 pt-6 mt-auto">
              <div className="flex items-center justify-between text-blue-600">
                <span className="text-xs font-black uppercase tracking-widest group-hover:underline">
            ...
            <div
              className={`absolute -bottom-10 -right-10 w-40 h-40 opacity-[0.03] rounded-full blur-3xl pointer-events-none ${
                !dashboardData.aiGuidance[0] ||
                dashboardData.aiGuidance[0].severity === "low"
                  ? "bg-emerald-600"
                  : dashboardData.aiGuidance[0].severity === "high"
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between mb-1">
            ...
            <Link
              href="/ai-guidance"
              onClick={(e) => e.stopPropagation()}
              className="text-[10px] font-bold text-gray-400 group-hover:text-blue-600 transition-colors uppercase tracking-widest no-underline"
            >
              View full guidance {"->"}
            </Link>
          </div>
              ...
              {isSummaryExpanded && (
                ...
                >
                  <p className="text-sm text-gray-500 font-medium pt-3 border-t border-gray-100">
                    AI can help you understand this better based on your
      ...
      <div className="space-y-4">
        {dashboardData.vitalsList.every(
          (v) => v.value === "--" || v.value === "No data yet",
        ) ? (
          <div className="card p-12 flex flex-col items-center justify-center text-center bg-gray-50/50 border-dashed border-2 border-gray-200">
            ...
            <p className="text-sm text-gray-500 font-medium max-w-xs mb-6">
              Log vitals to see insights, trends, and personalized pregnancy
              monitoring.
            </p>
            <ManualVitalsInput onSuccess={fetchDashboardData} />
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xl font-black text-gray-900 tracking-tight">
                  {(() => {
                    const criticalCount = dashboardData.vitalsList.filter(
                      (v) => v.status === "critical",
                    ).length;
                    const warningCount = dashboardData.vitalsList.filter(
                      (v) => v.status === "warning",
                    ).length;
                    if (criticalCount > 0)
                      return "Multiple vitals need immediate attention";
                    if (warningCount > 1)
                      return "Several vitals are slightly elevated";
                    if (warningCount === 1) {
                      const vital = dashboardData.vitalsList.find(
                        (v) => v.status === "warning",
                      );
              ...
              <Link
                href="/vitals"
                className="px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-xl text-[10px] font-black text-gray-900 uppercase tracking-widest transition-colors border border-gray-100"
              >
                Full Report {"->"}
              </Link>
            </div>
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                {chartData.length >= 2 && (
                  <span
                    className={`px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest border bg-${trendSummary.color}-50 text-${trendSummary.color}-600 border-${trendSummary.color}-100`}
                  >
                    {trendSummary.tag}
                  </span>
                )}
              ...
              <div className="flex p-1 bg-gray-50 rounded-xl border border-gray-100">
                {(["24h", "7d", "30d"] as const).map((p) => (
                  <button
                    key={p}
                    onClick={() => setPeriod(p)}
                    className={`text-[10px] uppercase font-black tracking-widest px-3 py-1.5 rounded-lg transition-all ${period === p ? "bg-white text-blue-600 shadow-sm" : "text-gray-400 hover:text-gray-600"}`}
                  >
                    {p}
                  </button>
                ))}
            ...
            <AnimatePresence mode="wait">
              {chartData.length > 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Area
                        ...
                        strokeWidth={2.5}
                        dot={(props) =>
                          renderSmartDot(props, 100, 50, "#3b82f6")
                        }
                        activeDot={{
                          r: 6,
                          strokeWidth: 2,
                      ...
                      <Area
                        ...
                        strokeWidth={2}
                        dot={(props) =>
                          renderSmartDot(props, 140, 90, "#8b5cf6")
                        }
                        activeDot={{
                          r: 5,
                          strokeWidth: 2,
                      ...
                      <Area
                        ...
                        strokeWidth={2}
                        dot={(props) =>
                          renderSmartDot(props, 100, 94, "#10b981")
                        }
                        activeDot={{
                          r: 5,
                          strokeWidth: 2,
                    ...
                    {trendPopup && (
                      ...
                      >
                        ...
                        <p className="text-[10px] text-emerald-500 font-bold mt-1.5 flex items-center gap-1">
                          ...
                          {trendPopup.value > 120 || trendPopup.value < 60
                            ? "Abnormal"
                            : "Healthy Pattern"}
                        </p>
                ...
                >
                  ...
                  <p className="text-[11px] text-gray-500 font-medium tracking-wide max-w-[200px]">
                    Start logging vitals to see patterns.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                {dashboardData.activeAlerts.some(
                  (a: any) =>
                    a.severity === "immediate" || a.severity === "critical",
                ) && (
            ...
            <Link
              href="/alerts"
              className="text-[10px] font-black text-gray-400 hover:text-blue-600 uppercase tracking-widest transition-colors no-underline"
            >
              View all {"->"}
            </Link>
          </div>
                ...
                {dashboardData.activeAlerts
                  ...
                  .map((a: any, i: number) => {
                    ...
                    return (
                      ...
                      >
                        {isCritical && (
                          <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-red-500 rounded-l-xl animate-pulse" />
                        )}
                        <span
                          className={`w-1.5 h-1.5 rounded-full flex-shrink-0 mt-1.5 ${dotColor} ${isCritical ? "animate-pulse" : ""}`}
                        />
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 mb-0.5">
                            <span
                              className={`text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full ${badgeStyle}`}
                            >
                              {isCritical
                                ? "Critical"
                                : a.severity === "high" ||
      ...
      <div className="grid grid-cols-3 gap-4">
              ...
              <div className="mb-4">
                ...
                {dashboardData.profile.pregnancy_week && (
                  <p className="text-sm font-bold text-gray-500 mt-0.5">
                    Week {dashboardData.profile.pregnancy_week} -{" "}
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center py-2 border-b border-gray-50">
                  ...
                  <span className="text-xs font-bold text-gray-800">
                    {(() => {
                      if (dashboardData.profile.due_date)
                        return format(
                          new Date(dashboardData.profile.due_date),
                          "dd MMM yyyy",
                        );
                      if (dashboardData.profile.pregnancy_week)
                        return format(
                          addWeeks(
                            new Date(),
                            40 - dashboardData.profile.pregnancy_week,
                          ),
                          "dd MMM yyyy",
                        );
                      return "Not set";
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-50">
                  ...
                  <span className="text-xs font-bold text-gray-800 truncate max-w-[120px] text-right">
                    {dashboardData.profile.provider_name}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-50">
                  <span className="text-[11px] text-gray-400 font-bold uppercase tracking-wider">
        ...
        <div className="card p-6 overflow-hidden flex flex-col max-h-[520px]">
            ...
            {selectedFeedItem && (
              ...
              >
                ...
                <p className="text-[9px] text-gray-500 mt-1.5 font-bold">
                  {selectedFeedItem.time} - tap to dismiss
                </p>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="space-y-1 overflow-y-auto flex-1 pr-1">
            {(() => {
              ...
              const todayGroup = dashboardData.activityFeed.find(
                (g: any) => g.header === "Today",
              );
              ...
              if (todayItems.length === 0) {
                return (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-[10px] text-gray-400 font-medium">
                      Start logging vitals or meals to see them here
                    </p>
                  </div>
                );
              }
                  ...
                  {todayItems.map((item: any, i: number) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[9px] text-gray-400 font-bold whitespace-nowrap flex-shrink-0">
                          {item.time}
                        </span>
                      </motion.div>
                    );
        ...
        <div className="card p-6 flex flex-col h-full bg-white">
          ...
          <div className="flex-1 space-y-4">
            {dashboardData.hydration.value === 0 &&
            dashboardData.sleep.value === 0 &&
            dashboardData.mood.value === "Not logged" ? (
              <div className="flex flex-col items-center justify-center py-10 text-center h-full">
                ...
                <p className="text-xs font-bold text-gray-600 mb-1">
                  Start logging to track your day
                </p>
                <p className="text-[10px] text-gray-400 font-medium">
                  Daily goals help maintain a healthy pregnancy
                </p>
              </div>
            ) : (
              <>
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-gray-900">
                          {dashboardData.hydration.value} / 2.5 L
                        </p>
                      </div>
                    </div>
                    <span className="text-[10px] font-black text-blue-600 tabular-nums">
                      {dashboardData.hydration.pct}%
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-[10px] font-bold ${dashboardData.hydration.pct >= 100 ? "text-emerald-600" : dashboardData.hydration.pct >= 50 ? "text-blue-600" : "text-amber-600"}`}
                    >
                      {dashboardData.hydration.pct >= 100
                        ? "Goal met"
                        : dashboardData.hydration.pct >= 70
                          ? "Good progress"
                          : "Needs intake"}
                    </span>
                      ...
                      >
                        <div className="pt-4 mt-3 border-t border-blue-100/50 space-y-2">
                          <p className="text-[10px] text-blue-700 font-medium leading-relaxed">
                            Hydration supports amniotic fluid levels and fetal
                            circulation.
                            <span className="block mt-1 font-bold">
                              Important for your current week.
                            </span>
                          </p>
                        </div>
                      </motion.div>
                ...
                <motion.div
                  ...
                  onClick={() =>
                    setExpandedMetric(
                      expandedMetric === "sleep" ? null : "sleep",
                    )
                  }
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-purple-600/60 uppercase tracking-widest">
                          Sleep
                        </p>
                        <p className="text-xs font-bold text-gray-900">
                          {dashboardData.sleep.value} / 8 hours
                        </p>
                      </div>
                    </div>
                    <span className="text-[10px] font-black text-purple-600 tabular-nums">
                      {dashboardData.sleep.pct}%
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-[10px] font-bold ${dashboardData.sleep.pct >= 90 ? "text-emerald-600" : dashboardData.sleep.pct >= 70 ? "text-purple-600" : "text-amber-600"}`}
                    >
                      ...
                      >
                        <div className="pt-4 mt-3 border-t border-purple-100/50 space-y-2">
                          <p className="text-[10px] text-purple-700 font-medium leading-relaxed">
                            Consistent rest helps regulate blood pressure and
                ...
                <motion.div
                  layout
                  onClick={() =>
                    setExpandedMetric(expandedMetric === "mood" ? null : "mood")
                  }
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-2">
                      <div
                        className={`p-1.5 bg-white rounded-lg shadow-sm ${moodConfig[dashboardData.mood.color].icon}`}
                      >
                        <Activity className="w-4 h-4" />
                      </div>
                      <div>
                        <p
                          className={`text-[10px] font-black ${moodConfig[dashboardData.mood.color].text}/60 uppercase tracking-widest`}
                        >
                          Mood
                        </p>
                        <p className="text-xs font-bold text-gray-900">
                          {dashboardData.mood.value}
                        </p>
                      </div>
                    </div>
                    <span
                      className={`text-[10px] font-black ${moodConfig[dashboardData.mood.color].text} tabular-nums`}
                    >
                      {dashboardData.mood.pct}%
                    </span>
                  </div>

                  <div
                    className={`h-1.5 w-full ${moodConfig[dashboardData.mood.color].bg} rounded-full overflow-hidden mb-2`}
                  >
                    <motion.div
                      initial={{ width: 0 }}
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-[10px] font-bold text-${dashboardData.mood.indicatorColor}-600`}
                    >
                      ...
                      >
                        <div className="pt-4 mt-3 border-t border-gray-100 space-y-2">
                          <p className="text-[10px] text-gray-600 font-medium leading-relaxed">
                            Emotional well-being is directly tied to
                ...
                >
                  ...
                  <div className="h-1.5 w-full bg-indigo-100/50 rounded-full overflow-hidden mb-2">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{
                        width: `${Math.min(100, (dashboardData.steps.value / 3000) * 100)}%`,
                      }}
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-[10px] font-bold ${dashboardData.steps.trend === "active" ? "text-indigo-600" : "text-gray-500"}`}
                    >
